...
```bash
dotnet add package Datafication.Core --version 1.0.4
dotnet add package Datafication.Storage.Velocity --version 1.0.4
dotnet add package Datafication.Server.Core --version 1.0.4
dotnet add package Datafication.CsvConnector --version 1.0.4
dotnet add package Datafication.ParquetConnector --version 1.0.4
dotnet add package Datafication.WebConnector --version 1.0.4
